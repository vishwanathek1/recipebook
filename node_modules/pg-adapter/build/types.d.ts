...
export declare type PgError = PgErrorClass;
export declare type ResultWithFields<T = any> = {
    fields: FieldInfo[];
    result: T;
};
...
export declare type DecodeFunction = (data: Buffer, pos: number, size: number) => void;
